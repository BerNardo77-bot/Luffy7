...
const DB_PATH = path.join((process.env.DATA_DIR || process.cwd()).replace(/\/$/, ''), 'database.json');
...
export const defSets = {
  ...
  banner: 'https://cdn.dev-ander.xyz/a/y7PO.png',
  icon: 'https://cdn.dev-ander.xyz/a/OdbH.png',
  currency: 'Berries💰',
  namebot: '୭౿ㅤׁ 🍃ᮢᩥ  𝖬𝗈𝗇𝗄𝖾𝗒 𝖣. 𝖫𝗎𝖿𝖿𝗒 .ᐟ  ֺ',
  namebot2: '𝖫𝗎𝖿𝖿𝗒',
